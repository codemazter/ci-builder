...
class Googlemaps {
	...
	var $map_div_id					= "mavas";				// The ID of the <div></div> that is output which contains the map
	var $map_height					= "440px";					// The height of the map container. Any units (ie 'px') can be used. If no units are provided 'px' will be presumed
